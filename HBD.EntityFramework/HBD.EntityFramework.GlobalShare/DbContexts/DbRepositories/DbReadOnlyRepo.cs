...
{
    public class DbReadOnlyRepo<TEntity> : IDbReadOnlyRepo<TEntity> where TEntity : class, IDbEntity
    {
        protected DbContext DbContext { get; }

        public DbReadOnlyRepo(IDbReadOnlyRepoFactory dbFactory, DbContext context)
        {
        ...
        protected IDbReadOnlyRepoFactory DbFactory { get; }
